...
public class Taxi extends ActionBarActivity implements LocationListener{
	...
	{ 
		...
		{
			try {
				loading = new ProgressDialog(Taxi.this);
		...
		{
			Intent n= new Intent(getApplicationContext(), SolicitarTaxi.class);
            startActivity(n); 
            finish(); 
